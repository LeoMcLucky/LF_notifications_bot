...
Ошибки и критические сообщения (ERROR и CRITICAL) теперь автоматически отправляются через Telegram-бота в чат администратора.
Это позволяет быстро получать уведомления о критических проблемах и отслеживать ошибки как в коде, так и из сторонних библиотек.

Пример сообщения в Telegram:
```
2026-03-11 14:30:05 | ERROR | Неожиданная ошибка: ConnectionError
```
